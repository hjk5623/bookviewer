...
public class BookDB {
	...
	public BookDB(int no, String title, String writer, double score, String genre, Date mdate, String state,
			String finish, int number, String image, String stroy, String markImage) {
		super();
		this.no = no;
		this.title = title;
		this.writer = writer;
